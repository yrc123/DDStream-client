...
@Component
class RemoteSslStoreProvider : SslStoreProvider{
    override fun getKeyStore(): KeyStore {
        val keyStore = KeyStore.getInstance("PKCS12")
        val password = charArrayOf('1', '2', '3', '4', '5', '6')
        keyStore.load(readStoreFromRemote(), password)
//        return keyStore
//        val encodedKeystore =
...
//        val decode = Decoders.BASE64.decode(encodedKeystore)
//        val bis = ByteArrayInputStream(decode)
//
//        val keyStore = KeyStore.getInstance("PKCS12")
...
//        val bytes: ByteArray = Files.readAllBytes(Paths.get(System.getenv("JAVA_HOME"), "/lib/security/cacerts"))
//        val keyStore = KeyStore.getInstance("JKS")
//        keyStore.load(ByteArrayInputStream(bytes), "123456".toCharArray())
//        return keyStore
        return null
    }
